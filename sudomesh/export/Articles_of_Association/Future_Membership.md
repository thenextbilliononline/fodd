---
title: Articles of Association Future Membership
permalink: /Articles_of_Association/Future_Membership/
---
...
Sudo room's process for becoming a member strives to balance the [values](/#Values "wikilink") of openness, access, and transparency against the community's need for members to hold respect for responsibility, accountability, and safe space. The members need to trust and respect one another in order to fully self-express and to perform sudo room as a creative community and hacker space.

Sudo room respectfully request that all prospective members remember that **trust** is essential for our community and can be very easy to build when we all bring with us love, our genuine selves, and mutual respect.

In this regard, sudo room has replaced its formerly centralized membership process with a peer-to-peer (or peer-oriented) path to membership. **In order to become a member of the sudo room, you must:**

1.  Become aware of sudo room's history, values, culture, physical space, virtual space, and other members:
    -   **history** -
    -   **values** -
    -   **culture** -
    -   **physical space**
        -   Come visit the space! If you can't find a good excuse, you can join for a “Newbie Night” at 6pm on Wednesdays before the 7pm weekly membership meeting.
    -   **virtual space**
        -   we're all over the tubes and interwebs! <https://sudoroom.org/humans>
    -   **members**
        -   member directory: <https://sudoroom.org/humans>
2.  Meet with at least one sudo room member to discuss becoming a member, getting feedback and help with the process.
3.  Sign up on this form: <https://sudoroom.org/membership>
4.  Come to a weekly sudo room meeting

The sudo room will engage in a process to reflect on your intention to join sudo room by:

1.  Ensuring you get a chance to communicate with at least one sudo room member about membership
2.  Allowing plenty of opportunities to come to the sudo room physical space, to meet other members as well as non-member participants, and to get a sense of the ongoing activities of the community.
3.  Provide online resources that fully detail many aspects of sudo room as possible that may help inform your decision about membership.
4.  Listening to other members to determine if there are any objections to your membership
    -   If there are any objections, you will receive an explanation, and potentially an optional request for more information or engagement with you.
